...
def main():
    # 加载原始点云
    with open('/RobotGrasp/pcl/ch1/Homework I/modelnet40_normal_resampled/'
              'modelnet40_shape_names.txt') as f:
        a = f.readlines()
    for i in a:
        point_cloud_pynt = PyntCloud.from_file(
            '/RobotGrasp/pcl/ch1/Homework I/modelnet40_normal_resampled/'
    ...
    o3d.visualization.draw_geometries([point_cloud_o3d, frame]) # 显示PCA主方向
